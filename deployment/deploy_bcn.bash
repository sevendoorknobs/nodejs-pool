...
cd ~
git clone https://github.com/sevendoorknobs/nodejs-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
mysql -u root --password=$ROOT_SQL_PASS < deployment/basebcn.sql
